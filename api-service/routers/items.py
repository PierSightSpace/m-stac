...
@router.get("/v1/collections/{collectionId}/items", response_model=stac.StacOutputBase)
...
@router.get("/v1/collections/{collectionId}/items/{itemId}", response_model=stac.StacOutputBase)
@cache(expire=3600, key_builder=my_key_builder)
@limiter.limit("5/minute")
