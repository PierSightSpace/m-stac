...
# app.add_middleware(TrustedHostMiddleware, allowed_hosts=["13.233.148.94", "localhost", "127.0.0.1", "49.36.67.172"])   # stac.eodata.piersight.space - Hostname for production
print("1")
